...
/*
Create Server and DB Logins Account prior to Restore

This creates a series of tsql statements for re-createing users based on existing server logins.
Run this on databases, such as Dev or Test, which are being restored from Prod.

source: https://github.com/mmessano/SQL/blob/master/DBLevelUserPermissions.sql
